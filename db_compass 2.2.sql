...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/12/2023 às 19:25
...
--
ALTER TABLE `tb_email_usuario`
  MODIFY `cd_email` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_privilegio`
  MODIFY `cd_privilegio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
