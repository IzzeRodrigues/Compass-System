...
function calcularImpostos()
{
    ...
    // }
    if (fretePeso != "" && fretePeso != NaN && fretePeso != undefined && fretePeso != null)
    {
        if (valorSusp != "" && valorSusp != NaN && valorSusp != undefined && valorSusp != null)
        {
            if (rctrc != "" && rctrc != NaN && rctrc != undefined && rctrc != null)
            {
                if (rcfdc != "" && rcfdc != NaN && rcfdc != undefined && rcfdc != null)
                {
                    if (GRIS != "" && GRIS != NaN && GRIS != undefined && GRIS != null)
                    {
                        if (pedagio != "" && pedagio != NaN && pedagio != undefined && pedagio != null)
                        {
                            if (estacionamento != "" && estacionamento != NaN && estacionamento != undefined && estacionamento != null)
                            {
                                if (IMO != "" && IMO != NaN && IMO != undefined && IMO != null)
                                {
                                    if (DTA_GVB != "" && DTA_GVB != NaN && DTA_GVB != undefined && DTA_GVB != null)
                                    {
                                        if (ajudantes != "" && ajudantes != NaN && ajudantes != undefined && ajudantes != null)
                                        {
                                            console.log('entrandoContaFinal 2')
                                            subTotal = parseFloat(fretePeso) + parseFloat(valorSusp) + parseFloat(rctrc) + parseFloat(rcfdc) + parseFloat(GRIS) + parseFloat(pedagio) + parseFloat(estacionamento) + parseFloat(IMO) + parseFloat(DTA_GVB) + parseFloat(ajudantes);
                                            console.log(subTotal);
