...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/12/2023 às 21:55
...
INSERT INTO `tb_cliente` (`cd_cliente`, `nm_empresa_cliente`, `ds_tipo_cliente`) VALUES
(2, 'Lucas Shop 2', 'Cliente Cargo'),
(3, 'Isa', 'Cliente Multi');
...
--
-- Despejando dados para a tabela `tb_email_responsavel_cliente`
--

INSERT INTO `tb_email_responsavel_cliente` (`cd_email_responsavel_cliente`, `nm_email_responsavel_cliente`, `cd_responsavel_cliente`) VALUES
(2, 'reilucascemmil@gmail.com', 2),
(3, 'isap4350@gmail.com', 3);
...
(7, 'ahamad.soufanji@aclcargo.com.br', 7),
(8, 'isabelle.prates@aclcargo.com.br', 8),
(9, 'takashi.arai@aclcargo.com.br', 9);
...
--
-- Despejando dados para a tabela `tb_responsavel_cliente`
--

INSERT INTO `tb_responsavel_cliente` (`cd_responsavel_cliente`, `nm_responsavel_cliente`, `nr_telefone_responsavel_cliente`, `cd_cliente`) VALUES
(2, 'Lucas Craveiro 2', '(13) 99999-9999', 2),
(3, 'Isabelle', '(13) 99999-9999', 3);
...
(7, 'Ahamad Martins Soufanji', 'Vendas e Relacionamento', '123', '51992618860'),
(8, 'Isabele Rodrigues Prates', 'Líder de Negócios', '123', '51992618860'),
(9, 'Takashi Vitorino Arai', 'Vendas e Relacionamento', '123', '51992618860');
...
--
ALTER TABLE `tb_email_responsavel_cliente`
  MODIFY `cd_email_responsavel_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tb_email_usuario`
  MODIFY `cd_email` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_privilegio`
  MODIFY `cd_privilegio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_responsavel_cliente`
  MODIFY `cd_responsavel_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tb_email_usuario`
  ADD CONSTRAINT `fk_email_usuario_usuario` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE CASCADE;
...
--
ALTER TABLE `tb_privilegio`
  ADD CONSTRAINT `fk_privilegio_usuario` FOREIGN KEY (`cd_usuario`) REFERENCES `tb_usuario` (`cd_usuario`) ON DELETE CASCADE;
