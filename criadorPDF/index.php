        ...
        $clausulaDigital = '<div style=" border:0.5px solid black; border-top:none;">
            <table style="">
                <tr>
                    <td>
                    *DOCUMENTO ORIGINAL Grupo ACL Cargo SEDE: Rua Alexandre Gusmão, 11 CJ. 1315/16/17/18
                    Santos (SP) devidamente inscrita no e-CNPJ/A1 certificado sob o número ' . $cnpjFilial . ', neste representado por ' . $variaveis->usuario[0]->nm_nome_completo . ' portador(a) do documento de número ' . 'CPF de TESTE' . ', possuindo o contato ' . $variaveis->usuario[0]->nm_email_usuario . '  Encontra-se de acordo com a proposta apresentada nesse documento.         
                    </td>
                </tr>
            </table>
            </div>';
