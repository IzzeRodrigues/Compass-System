...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/11/2023 às 07:29
...
CREATE TABLE `tb_adicionais` (
  ...
  `id_isca_adicionais` char(3) DEFAULT NULL,
  `vl_isca_adicionais` decimal(10,2) DEFAULT NULL,
  `id_monitoramento_isca_adicionais` varchar(3) DEFAULT NULL,
  `vl_monitoramento_isca_adicionais` decimal(10,2) DEFAULT NULL,
  `id_escolta_armada_adicionais` char(3) DEFAULT NULL,
  `vl_escolta_armada_adicionais` decimal(10,2) DEFAULT NULL,
  `id_adic_carga_imo_adicionais` char(3) DEFAULT NULL,
  `vl_adic_carga_imo_adicionais` decimal(10,2) DEFAULT NULL,
  `id_carregamento_expr_adicionais` char(3) DEFAULT NULL,
  `vl_carregamento_expr_adicionais` decimal(10,2) DEFAULT NULL,
  `id_util_cav_ls_adicionais` char(3) DEFAULT NULL,
  `vl_util_cav_ls_adicionais` decimal(10,2) DEFAULT NULL,
  `id_estadia_especial_adicionais` varchar(20) DEFAULT NULL,
  `vl_estadia_especial_adicionais` decimal(10,2) DEFAULT NULL,
  `id_sobrestadia_carreg_adicionais` char(3) DEFAULT NULL,
  `vl_sobrestadia_carreg_adicionais` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `tb_despesas` (
  ...
  `nm_motorista_despesas` varchar(100) DEFAULT NULL,
...
CREATE TABLE `tb_imp_despesas` (
  ...
  `nm_rota_icms_despesas` varchar(10) DEFAULT NULL,
...
CREATE TABLE `tb_motorista` (
  ...
  `vl_mototrista` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `tb_valor_carga` (
  ...
  `nm_tipo_moeda_valor_carga` decimal(10,2) DEFAULT NULL,
...
--
ALTER TABLE `tb_adicionais`
  ADD CONSTRAINT `fk_adicionais_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_adic_despesas`
--
ALTER TABLE `tb_adic_despesas`
  ADD CONSTRAINT `fk_adic_despesas_despesas` FOREIGN KEY (`cd_despesas`) REFERENCES `tb_despesas` (`cd_despesas`);

--
-- Restrições para tabelas `tb_adic_operacao`
--
ALTER TABLE `tb_adic_operacao`
  ADD CONSTRAINT `fk_adic_operacao_operacao` FOREIGN KEY (`cd_operacao`) REFERENCES `tb_operacao` (`cd_operacao`);
...
--
ALTER TABLE `tb_despesas`
  ADD CONSTRAINT `fk_despesas_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);
...
--
ALTER TABLE `tb_imp_despesas`
  ADD CONSTRAINT `fk_imp_despesas_despesas` FOREIGN KEY (`cd_despesas`) REFERENCES `tb_despesas` (`cd_despesas`);

--
-- Restrições para tabelas `tb_imp_operacao`
--
ALTER TABLE `tb_imp_operacao`
  ADD CONSTRAINT `fk_imp_operacao_operacao` FOREIGN KEY (`cd_operacao`) REFERENCES `tb_operacao` (`cd_operacao`);

--
-- Restrições para tabelas `tb_km_rota_carga`
--
ALTER TABLE `tb_km_rota_carga`
  ADD CONSTRAINT `fk_km_ida_carga_carga` FOREIGN KEY (`cd_carga`) REFERENCES `tb_carga` (`cd_carga`);

--
-- Restrições para tabelas `tb_mercadoria_operacao`
--
ALTER TABLE `tb_mercadoria_operacao`
  ADD CONSTRAINT `fk_mercadoria_operacao_operacao` FOREIGN KEY (`cd_operacao`) REFERENCES `tb_operacao` (`cd_operacao`);

--
-- Restrições para tabelas `tb_motorista`
--
ALTER TABLE `tb_motorista`
  ADD CONSTRAINT `fk_motorista_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);
...
--
ALTER TABLE `tb_pedagio_rota_carga`
  ADD CONSTRAINT `fk_pedagio_rota_carga_carga` FOREIGN KEY (`cd_carga`) REFERENCES `tb_carga` (`cd_carga`);
...
--
ALTER TABLE `tb_rota`
  ADD CONSTRAINT `fk_rota_proposta` FOREIGN KEY (`cd_rota`) REFERENCES `tb_proposta` (`cd_proposta`);
...
--
ALTER TABLE `tb_valor_carga`
  ADD CONSTRAINT `fk_valor_carga_carga` FOREIGN KEY (`cd_carga`) REFERENCES `tb_carga` (`cd_carga`);
