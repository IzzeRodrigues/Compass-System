...
<html lang="pt-BR">
    ...
    <body class="sb-nav-fixed dashboardTxt">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark bg-perso">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 fs-5" href="#">ACL Cargo</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/addcliente">Adicionar</a>
                                    <a class="nav-link" href="/gercliente">Procurar</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed" href="/addproposta" data-bs-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                        Adicionar
                                    </a>
        ...
        <script src="js/comercial-datatables-simple-demo.js"></script>
