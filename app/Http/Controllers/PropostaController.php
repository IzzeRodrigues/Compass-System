...
class PropostaController extends Controller
{
    ...
    function atualizarProposta()
    {
        ...
        $idProposta = DB::table('tb_proposta')->where('tb_proposta.cd_proposta', '=', $_SESSION['proposta']['idProposta'])->update(['ds_tipo_proposta' => $_SESSION['proposta']['tipoProposta'],'dt_proposta' => $_SESSION['proposta']['valorDataProposta'],'nm_referencia_acl' => $referenciaAcl, 'nm_referencia_cliente' => $_SESSION['proposta']['valorReferenciaCliente'], 'nm_versao_proposta' => $_SESSION['proposta']['valorVersaoProposta'], 'dt_horario_recebimento' => $_SESSION['proposta']['valorHorarioRecebimento'], 'ds_metodo_transporte' => $_SESSION['proposta']['valorTipoFrete'], 'ds_status_proposta' => 'Não-Enviada', 'ds_tipo_assinatura' => 'Não-Selecionada', 'cd_usuario' => $EmailResponsavel[0]->cd_usuario]);
        ...
        $idMercadoriaOperacao = DB::table('tb_mercadoria_operacao')->where('tb_mercadoria_operacao.cd_operacao', '=', $ids[1][0]->cd_operacao)->update(['vl_mercadoria_operacao' => $_SESSION['proposta']['valorMercadoria'], 'vl_container_operacao' => $_SESSION['proposta']['container'], 'cd_operacao' => $idOperacao]);
