...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/11/2023 às 20:54
...
--
ALTER TABLE `tb_combustivel_carga`
  ADD CONSTRAINT `fk_combustivel_carga` FOREIGN KEY (`cd_carga`) REFERENCES `tb_carga` (`cd_carga`);
...
--
ALTER TABLE `tb_filial`
  ADD CONSTRAINT `fk_filial_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);
