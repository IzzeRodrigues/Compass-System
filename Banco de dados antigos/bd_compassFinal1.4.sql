...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/11/2023 às 20:46
...
--
-- Estrutura para tabela `tb_adic_imo`
--

CREATE TABLE `tb_adic_imo` (
  `cd_adic_imo` int(11) NOT NULL,
  `id_adic_imo` char(3) DEFAULT NULL,
  `vl_adic_imo` decimal(10,2) DEFAULT NULL,
...
--
-- Estrutura para tabela `tb_carregamento_exp`
--

CREATE TABLE `tb_carregamento_exp` (
  `cd_carregamento_exp` int(11) NOT NULL,
  `id_carregamento_exp` char(3) DEFAULT NULL,
  `vl_carregamento_exp` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_cat_imposto_operacao`
--
...
--
-- Estrutura para tabela `tb_cavalo_ls`
--

CREATE TABLE `tb_cavalo_ls` (
  `cd_cavalo_ls` int(11) NOT NULL,
  `id_cavalo_ls` char(3) DEFAULT NULL,
  `vl_cavalo_ls` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_cidade_destino`
--
...
--
-- Estrutura para tabela `tb_cidade_origem`
--
...
--
-- Estrutura para tabela `tb_class_imo`
--
...
--
-- Estrutura para tabela `tb_comb_total_litro_carga`
--

CREATE TABLE `tb_comb_total_litro_carga` (
  `cd_comb_total_litro_carga` int(11) NOT NULL,
  `qtd_comb_total_litro_carga` decimal(6,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_consumo_medio_km_litro_carga`
--

CREATE TABLE `tb_consumo_medio_km_litro_carga` (
  `cd_consumo_medio_km_litro_carga` int(11) NOT NULL,
  `qtd_consumo_medio_km_litro_carga` decimal(5,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_cotacao_carga`
--

CREATE TABLE `tb_cotacao_carga` (
  `cd_cotacao_carga` int(11) NOT NULL,
  `vl_cotacao_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_despesa_total_viagem_carga`
--

CREATE TABLE `tb_despesa_total_viagem_carga` (
  `cd_despesa_total_viagem_carga` int(11) NOT NULL,
  `vl_despesa_total_viagem_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_desp_operacao`
--

CREATE TABLE `tb_desp_operacao` (
  `cd_desp_operacao` int(11) NOT NULL,
  `vl_pedagio_desp_operacao` decimal(10,2) DEFAULT NULL,
  `vl_estacionamento_desp_operacao` decimal(10,2) DEFAULT NULL,
  `vl_dta_desp_operacao` decimal(10,2) DEFAULT NULL,
  `vl_ajudantes_desp_operacao` decimal(10,2) DEFAULT NULL,
  `vl_total_desp_operacao` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_eixos`
--

CREATE TABLE `tb_eixos` (
  `cd_eixos` int(11) NOT NULL,
  `qtd_eixos` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Estrutura para tabela `tb_eixos_carga`
--
...
--
-- Estrutura para tabela `tb_eixos_tipo_carga`
--

CREATE TABLE `tb_eixos_tipo_carga` (
  `cd_eixos` int(11) NOT NULL,
  `cd_tipo_carga` int(11) NOT NULL,
  `cd_tipo_op` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_escolta_armada`
--

CREATE TABLE `tb_escolta_armada` (
  `cd_escolta_armada` int(11) NOT NULL,
  `id_escolta_armada` char(3) DEFAULT NULL,
  `vl_escolta_armada` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_estadia_esp`
--

CREATE TABLE `tb_estadia_esp` (
  `cd_estadia_esp` int(11) NOT NULL,
  `id_estadia_esp` char(3) DEFAULT NULL,
  `vl_estadia_esp` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_frete_all_in_fechado_motorista`
--
...
--
-- Estrutura para tabela `tb_frete_conf_antt_motorista`
--
...
--
-- Estrutura para tabela `tb_frete_peso_operacao`
--

CREATE TABLE `tb_frete_peso_operacao` (
  `cd_frete_peso_operacao` int(11) NOT NULL,
  `vl_frete_peso_operacao` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_icms_despesa`
--

CREATE TABLE `tb_icms_despesa` (
  `cd_icms_despesa` int(11) NOT NULL,
  `nm_rota_icms_despesa` varchar(10) DEFAULT NULL,
  `vl_icms_despesa` decimal(10,2) DEFAULT NULL,
  `pc_icms_despesa` decimal(5,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_imp_despesa`
--

CREATE TABLE `tb_imp_despesa` (
  `cd_imp_despesa` int(11) NOT NULL,
  `pc_rcfdc_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_rcfdc_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_rctrc_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_rctrc_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_simples_nac_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_simples_nac_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_irpj_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_irpj_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_adic_irpj_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_adic_irpj_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_pis_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_pis_imp_despesa` decimal(10,2) DEFAULT NULL,
  `pc_cofins_imp_despesa` decimal(5,2) DEFAULT NULL,
  `vl_cofins_imp_despesa` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_isca`
--

CREATE TABLE `tb_isca` (
  `cd_isca` int(11) NOT NULL,
  `id_isca` char(3) DEFAULT NULL,
  `vl_isca` decimal(10,2) DEFAULT NULL,
  `id_monitoramento_isca` varchar(3) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_km_ida_carga`
--

CREATE TABLE `tb_km_ida_carga` (
  `cd_km_ida_carga` int(11) NOT NULL,
  `qtd_km_ida_carga` decimal(6,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_km_volta_carga`
--

CREATE TABLE `tb_km_volta_carga` (
  `cd_km_volta_carga` int(11) NOT NULL,
  `qtd_km_volta_carga` decimal(6,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_local_devolucao_container`
--
...
--
-- Estrutura para tabela `tb_lucro_bruto_operacao`
--
...
CREATE TABLE `tb_lucro_bruto_operacao` (
  ...
  `pc_lucro_bruto_operacao` decimal(5,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_lucro_frete_all_in_fechado_motorista`
--
...
--
-- Estrutura para tabela `tb_lucro_tentar_fechar_motorista`
--
...
--
-- Estrutura para tabela `tb_lucro_total_aut_tab_motorista`
--
...
--
-- Estrutura para tabela `tb_margem_operacao`
--

CREATE TABLE `tb_margem_operacao` (
  `cd_margem_operacao` int(11) NOT NULL,
  `vl_margem_operacao` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_mot_despesa`
--

CREATE TABLE `tb_mot_despesa` (
  `cd_mot_despesa` int(11) NOT NULL,
  `vl_mot_autonomo_despesa` decimal(10,2) DEFAULT NULL,
  `vl_pedagio_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_buonny_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_gris_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_dta_di_terc_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_estacionamento_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_ajudante_mot_despesa` decimal(10,2) DEFAULT NULL,
  `vl_profit_mot_despesa` decimal(10,2) DEFAULT NULL,
  `pc_comissao_mot_despesa` decimal(5,2) DEFAULT NULL,
  `vl_comissao_mot_despesa` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_pedagio_ida_eixo_carga`
--

CREATE TABLE `tb_pedagio_ida_eixo_carga` (
  `cd_pedagio_ida_eixo_carga` int(11) NOT NULL,
  `vl_pedagio_ida_eixo_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_pedagio_volta_eixo_carga`
--

CREATE TABLE `tb_pedagio_volta_eixo_carga` (
  `cd_pedagio_volta_eixo_carga` int(11) NOT NULL,
  `vl_pedagio_volta_eixo_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_preco_litro_comb_carga`
--

CREATE TABLE `tb_preco_litro_comb_carga` (
  `cd_preco_litro_comb_carga` int(11) NOT NULL,
  `vl_preco_litro_comb_carga` decimal(5,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `tb_proposta` (
  ...
  `nm_referencia_cliente` varchar(50) NOT NULL,
  `nm_versao_proposta` varchar(50) NOT NULL,
...
CREATE TABLE `tb_rota` (
  ...
  `nm_cidade_origem` varchar(50) NOT NULL,
  `sg_uf_origem` char(2) NOT NULL,
  `nm_cidade_destino` varchar(50) NOT NULL,
  `sg_uf_destino` char(2) NOT NULL,
  `cd_proposta` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_subtotal_operacao`
--

CREATE TABLE `tb_subtotal_operacao` (
  `cd_subtotal_operacao` int(11) NOT NULL,
...
--
-- Estrutura para tabela `tb_tentar_fechar_motorista`
--
...
--
-- Estrutura para tabela `tb_tipo_carga`
--
...
--
-- Estrutura para tabela `tb_tipo_moeda_carga`
--
...
--
-- Estrutura para tabela `tb_tipo_op`
--

CREATE TABLE `tb_tipo_op` (
  `cd_tipo_op` int(11) NOT NULL,
  `nm_tipo_op` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_total_aut_motorista`
--

CREATE TABLE `tb_total_aut_motorista` (
  `cd_total_aut_motorista` int(11) NOT NULL,
  `vl_total_aut_motorista` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_total_despesa`
--

CREATE TABLE `tb_total_despesa` (
  `cd_total_despesa` int(11) NOT NULL,
  `vl_total_despesa` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_total_imp_seg_operacao`
--

CREATE TABLE `tb_total_imp_seg_operacao` (
  `cd_total_imp_seg_operacao` int(11) NOT NULL,
  `vl_total_imp_seg_operacao` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_total_km_carga`
--

CREATE TABLE `tb_total_km_carga` (
  `cd_total_km_carga` int(11) NOT NULL,
  `vl_total_km_carga` decimal(6,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_total_prest_operacao`
--
...
--
-- Estrutura para tabela `tb_uf_destino`
--
...
--
-- Estrutura para tabela `tb_uf_origem`
--
...
(4, 'Lucas Craveiro', 'Diretoria Geral', '123');

-- --------------------------------------------------------

--
-- Estrutura para tabela `tb_vale_pedagio_tab_motorista`
--

CREATE TABLE `tb_vale_pedagio_tab_motorista` (
  `cd_vale_pedagio_tab_motorista` int(11) NOT NULL,
  `vl_vale_pedagio_tab_motorista` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valores_motorista`
--

CREATE TABLE `tb_valores_motorista` (
  `cd_valores_motorista` int(11) NOT NULL,
  `vl_valores_mototrista` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valor_carga_brl_carga`
--

CREATE TABLE `tb_valor_carga_brl_carga` (
  `cd_valor_carga_brl_carga` int(11) NOT NULL,
  `vl_valor_carga_brl_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valor_carga_op`
--

CREATE TABLE `tb_valor_carga_op` (
  `cd_valor_carga_op` int(11) NOT NULL,
  `vl_valor_carga_op` decimal(20,2) DEFAULT NULL,
...
--
-- Estrutura para tabela `tb_valor_carga_usd_eur_carga`
--

CREATE TABLE `tb_valor_carga_usd_eur_carga` (
  `cd_valor_carga_usd_eur_carga` int(11) NOT NULL,
  `vl_carga_usd_eur_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valor_container_operacao`
--
...
--
-- Estrutura para tabela `tb_valor_icms_operacao`
--

CREATE TABLE `tb_valor_icms_operacao` (
  `cd_valor_icms_operacao` int(11) NOT NULL,
  `nm_rota_icms_operacao` varchar(10) DEFAULT NULL,
...
--
-- Estrutura para tabela `tb_valor_merc_operacao`
--

CREATE TABLE `tb_valor_merc_operacao` (
  `cd_valor_merc_operacao` int(11) NOT NULL,
  `vl_valor_merc_operacao` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valor_total_comb_carga`
--

CREATE TABLE `tb_valor_total_comb_carga` (
  `cd_valor_total_comb_carga` int(11) NOT NULL,
  `vl_total_comb_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Estrutura para tabela `tb_valor_total_pedagio_carga`
--

CREATE TABLE `tb_valor_total_pedagio_carga` (
  `cd_valor_total_pedagio_carga` int(11) NOT NULL,
  `vl_total_pedagio_carga` decimal(10,2) DEFAULT NULL,
  `cd_proposta` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- Índices de tabela `tb_adic_imo`
--
ALTER TABLE `tb_adic_imo`
  ADD PRIMARY KEY (`cd_adic_imo`),
  ADD KEY `fk_adic_imo_proposta` (`cd_proposta`);
...
--
-- Índices de tabela `tb_carregamento_exp`
--
ALTER TABLE `tb_carregamento_exp`
  ADD PRIMARY KEY (`cd_carregamento_exp`),
  ADD KEY `fk_carregamento_exp_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_cat_imposto_operacao`
--
...
--
-- Índices de tabela `tb_cavalo_ls`
--
ALTER TABLE `tb_cavalo_ls`
  ADD PRIMARY KEY (`cd_cavalo_ls`),
  ADD KEY `fk_cavalo_ls_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_cidade_destino`
--
...
--
-- Índices de tabela `tb_cidade_origem`
--
...
--
-- Índices de tabela `tb_class_imo`
--
...
--
-- Índices de tabela `tb_comb_total_litro_carga`
--
...
--
-- Índices de tabela `tb_consumo_medio_km_litro_carga`
--
...
--
-- Índices de tabela `tb_cotacao_carga`
--
...
--
-- Índices de tabela `tb_despesa_total_viagem_carga`
--
...
--
-- Índices de tabela `tb_desp_operacao`
--
ALTER TABLE `tb_desp_operacao`
  ADD PRIMARY KEY (`cd_desp_operacao`),
  ADD KEY `fk_desp_operacao_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_eixos`
--
ALTER TABLE `tb_eixos`
  ADD PRIMARY KEY (`cd_eixos`);

--
-- Índices de tabela `tb_eixos_carga`
--
...
--
-- Índices de tabela `tb_eixos_tipo_carga`
--
ALTER TABLE `tb_eixos_tipo_carga`
  ADD PRIMARY KEY (`cd_eixos`,`cd_tipo_carga`),
  ADD KEY `fk_eixos_tipo_carga` (`cd_tipo_carga`),
  ADD KEY `fk_tipo_op` (`cd_tipo_op`);
...
--
-- Índices de tabela `tb_escolta_armada`
--
ALTER TABLE `tb_escolta_armada`
  ADD PRIMARY KEY (`cd_escolta_armada`),
  ADD KEY `fk_escolta_armada_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_estadia_esp`
--
ALTER TABLE `tb_estadia_esp`
  ADD PRIMARY KEY (`cd_estadia_esp`),
  ADD KEY `fk_estadia_esp_proposta` (`cd_proposta`);
...
--
-- Índices de tabela `tb_frete_all_in_fechado_motorista`
--
...
--
-- Índices de tabela `tb_frete_conf_antt_motorista`
--
...
--
-- Índices de tabela `tb_frete_peso_operacao`
--
...
--
-- Índices de tabela `tb_icms_despesa`
--
ALTER TABLE `tb_icms_despesa`
  ADD PRIMARY KEY (`cd_icms_despesa`),
  ADD KEY `fk_icms_despesa_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_imp_despesa`
--
ALTER TABLE `tb_imp_despesa`
  ADD PRIMARY KEY (`cd_imp_despesa`),
  ADD KEY `fk_imp_despesa_proposta` (`cd_proposta`);
...
ALTER TABLE `tb_imp_operacao`
  ...
  ADD KEY `fk_imp_operacao_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_isca`
--
ALTER TABLE `tb_isca`
  ADD PRIMARY KEY (`cd_isca`),
  ADD KEY `fk_isca_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_km_ida_carga`
--
...
--
-- Índices de tabela `tb_km_volta_carga`
--
ALTER TABLE `tb_km_volta_carga`
  ADD PRIMARY KEY (`cd_km_volta_carga`),
  ADD KEY `fk_km_volta_carga_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_local_devolucao_container`
--
...
--
-- Índices de tabela `tb_lucro_bruto_operacao`
--
...
--
-- Índices de tabela `tb_lucro_frete_all_in_fechado_motorista`
--
...
--
-- Índices de tabela `tb_lucro_tentar_fechar_motorista`
--
...
--
-- Índices de tabela `tb_lucro_total_aut_tab_motorista`
--
...
--
-- Índices de tabela `tb_margem_operacao`
--
...
--
-- Índices de tabela `tb_mot_despesa`
--
ALTER TABLE `tb_mot_despesa`
  ADD PRIMARY KEY (`cd_mot_despesa`),
  ADD KEY `fk_mot_despesa_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_pedagio_ida_eixo_carga`
--
...
--
-- Índices de tabela `tb_pedagio_volta_eixo_carga`
--
...
--
-- Índices de tabela `tb_preco_litro_comb_carga`
--
...
--
-- Índices de tabela `tb_subtotal_operacao`
--
ALTER TABLE `tb_subtotal_operacao`
  ADD PRIMARY KEY (`cd_subtotal_operacao`),
  ADD KEY `fk_subtotal_operacao_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_tentar_fechar_motorista`
--
...
--
-- Índices de tabela `tb_tipo_carga`
--
...
--
-- Índices de tabela `tb_tipo_moeda_carga`
--
...
--
-- Índices de tabela `tb_tipo_op`
--
ALTER TABLE `tb_tipo_op`
  ADD PRIMARY KEY (`cd_tipo_op`);
...
--
-- Índices de tabela `tb_total_aut_motorista`
--
...
--
-- Índices de tabela `tb_total_despesa`
--
ALTER TABLE `tb_total_despesa`
  ADD PRIMARY KEY (`cd_total_despesa`),
  ADD KEY `fk_total_despesa_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_total_imp_seg_operacao`
--
ALTER TABLE `tb_total_imp_seg_operacao`
  ADD PRIMARY KEY (`cd_total_imp_seg_operacao`),
  ADD KEY `fk_total_imp_seg_operacao_proposta` (`cd_proposta`);

--
-- Índices de tabela `tb_total_km_carga`
--
...
--
-- Índices de tabela `tb_total_prest_operacao`
--
...
--
-- Índices de tabela `tb_uf_destino`
--
...
--
-- Índices de tabela `tb_uf_origem`
--
...
--
-- Índices de tabela `tb_vale_pedagio_tab_motorista`
--
...
--
-- Índices de tabela `tb_valores_motorista`
--
...
--
-- Índices de tabela `tb_valor_carga_brl_carga`
--
...
--
-- Índices de tabela `tb_valor_carga_op`
--
ALTER TABLE `tb_valor_carga_op`
  ADD PRIMARY KEY (`cd_valor_carga_op`),
  ADD KEY `fk_valor_tipo_carga` (`cd_tipo_carga`);

--
-- Índices de tabela `tb_valor_carga_usd_eur_carga`
--
...
--
-- Índices de tabela `tb_valor_container_operacao`
--
...
--
-- Índices de tabela `tb_valor_icms_operacao`
--
...
--
-- Índices de tabela `tb_valor_merc_operacao`
--
...
--
-- Índices de tabela `tb_valor_total_comb_carga`
--
...
--
-- Índices de tabela `tb_valor_total_pedagio_carga`
--
...
--
-- AUTO_INCREMENT de tabela `tb_adic_imo`
--
ALTER TABLE `tb_adic_imo`
  MODIFY `cd_adic_imo` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_carregamento_exp`
--
ALTER TABLE `tb_carregamento_exp`
  MODIFY `cd_carregamento_exp` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_cavalo_ls`
--
ALTER TABLE `tb_cavalo_ls`
  MODIFY `cd_cavalo_ls` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_desp_operacao`
--
ALTER TABLE `tb_desp_operacao`
  MODIFY `cd_desp_operacao` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_eixos`
--
ALTER TABLE `tb_eixos`
  MODIFY `cd_eixos` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_escolta_armada`
--
ALTER TABLE `tb_escolta_armada`
  MODIFY `cd_escolta_armada` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_estadia_esp`
--
ALTER TABLE `tb_estadia_esp`
  MODIFY `cd_estadia_esp` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_icms_despesa`
--
ALTER TABLE `tb_icms_despesa`
  MODIFY `cd_icms_despesa` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_imp_despesa`
--
ALTER TABLE `tb_imp_despesa`
  MODIFY `cd_imp_despesa` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_isca`
--
ALTER TABLE `tb_isca`
  MODIFY `cd_isca` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_mot_despesa`
--
ALTER TABLE `tb_mot_despesa`
  MODIFY `cd_mot_despesa` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_subtotal_operacao`
--
ALTER TABLE `tb_subtotal_operacao`
  MODIFY `cd_subtotal_operacao` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_tipo_op`
--
ALTER TABLE `tb_tipo_op`
  MODIFY `cd_tipo_op` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_total_despesa`
--
ALTER TABLE `tb_total_despesa`
  MODIFY `cd_total_despesa` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_total_imp_seg_operacao`
--
ALTER TABLE `tb_total_imp_seg_operacao`
  MODIFY `cd_total_imp_seg_operacao` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `tb_valor_carga_op`
--
ALTER TABLE `tb_valor_carga_op`
  MODIFY `cd_valor_carga_op` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Restrições para tabelas `tb_adic_imo`
--
ALTER TABLE `tb_adic_imo`
  ADD CONSTRAINT `fk_adic_imo_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);
...
--
-- Restrições para tabelas `tb_carregamento_exp`
--
ALTER TABLE `tb_carregamento_exp`
  ADD CONSTRAINT `fk_carregamento_exp_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_cat_imposto_operacao`
--
ALTER TABLE `tb_cat_imposto_operacao`
  ADD CONSTRAINT `fk_cat_imposto_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_cavalo_ls`
--
ALTER TABLE `tb_cavalo_ls`
  ADD CONSTRAINT `fk_cavalo_ls_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_cidade_destino`
--
ALTER TABLE `tb_cidade_destino`
  ADD CONSTRAINT `fk_cidade_destino_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_cidade_origem`
--
ALTER TABLE `tb_cidade_origem`
  ADD CONSTRAINT `fk_cidade_origem_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_class_imo`
--
ALTER TABLE `tb_class_imo`
...
--
-- Restrições para tabelas `tb_cotacao_carga`
--
ALTER TABLE `tb_cotacao_carga`
...
--
-- Restrições para tabelas `tb_despesa_total_viagem_carga`
--
ALTER TABLE `tb_despesa_total_viagem_carga`
  ADD CONSTRAINT `fk_despesa_total_viagem_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_desp_operacao`
--
ALTER TABLE `tb_desp_operacao`
  ADD CONSTRAINT `fk_desp_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_eixos_carga`
--
ALTER TABLE `tb_eixos_carga`
  ADD CONSTRAINT `fk_eixos_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_eixos_tipo_carga`
--
ALTER TABLE `tb_eixos_tipo_carga`
  ADD CONSTRAINT `fk_eixos` FOREIGN KEY (`cd_eixos`) REFERENCES `tb_eixos` (`cd_eixos`),
  ADD CONSTRAINT `fk_eixos_tipo_carga` FOREIGN KEY (`cd_tipo_carga`) REFERENCES `tb_tipo_carga` (`cd_tipo_carga`),
  ADD CONSTRAINT `fk_tipo_op` FOREIGN KEY (`cd_tipo_op`) REFERENCES `tb_tipo_op` (`cd_tipo_op`);

--
-- Restrições para tabelas `tb_email_responsavel_cliente`
--
ALTER TABLE `tb_email_responsavel_cliente`
  ADD CONSTRAINT `fk_email_responsavel_cliente_responsavel` FOREIGN KEY (`cd_responsavel_cliente`) REFERENCES `tb_responsavel_cliente` (`cd_responsavel_cliente`);
...
--
-- Restrições para tabelas `tb_escolta_armada`
--
ALTER TABLE `tb_escolta_armada`
  ADD CONSTRAINT `fk_escolta_armada_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_estadia_esp`
--
ALTER TABLE `tb_estadia_esp`
  ADD CONSTRAINT `fk_estadia_esp_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_frete_all_in_fechado_motorista`
--
ALTER TABLE `tb_frete_all_in_fechado_motorista`
  ADD CONSTRAINT `fk_frete_all_in_fechado_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_frete_conf_antt_motorista`
--
ALTER TABLE `tb_frete_conf_antt_motorista`
...
--
ALTER TABLE `tb_frete_peso`
  ADD CONSTRAINT `fk_frete_peso_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_frete_peso_operacao`
--
ALTER TABLE `tb_frete_peso_operacao`
  ADD CONSTRAINT `fk_frete_peso_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_icms_despesa`
--
ALTER TABLE `tb_icms_despesa`
  ADD CONSTRAINT `fk_icms_despesa_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_imp_despesa`
--
ALTER TABLE `tb_imp_despesa`
  ADD CONSTRAINT `fk_imp_despesa_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_imp_operacao`
--
ALTER TABLE `tb_imp_operacao`
  ADD CONSTRAINT `fk_imp_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_isca`
--
ALTER TABLE `tb_isca`
  ADD CONSTRAINT `fk_isca_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_km_ida_carga`
--
ALTER TABLE `tb_km_ida_carga`
  ADD CONSTRAINT `fk_km_ida_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_km_volta_carga`
--
ALTER TABLE `tb_km_volta_carga`
  ADD CONSTRAINT `fk_km_volta_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_local_devolucao_container`
--
ALTER TABLE `tb_local_devolucao_container`
  ADD CONSTRAINT `fk_local_devolucao_container_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_lucro_bruto_operacao`
--
ALTER TABLE `tb_lucro_bruto_operacao`
  ADD CONSTRAINT `fk_lucro_bruto_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_lucro_frete_all_in_fechado_motorista`
--
ALTER TABLE `tb_lucro_frete_all_in_fechado_motorista`
  ADD CONSTRAINT `fk_lucro_frete_all_in_fechado_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_lucro_tentar_fechar_motorista`
--
ALTER TABLE `tb_lucro_tentar_fechar_motorista`
  ADD CONSTRAINT `fk_lucro_tentar_fechar_motorista_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_lucro_total_aut_tab_motorista`
--
ALTER TABLE `tb_lucro_total_aut_tab_motorista`
  ADD CONSTRAINT `fk_lucro_total_aut_tab_motorista_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_margem_operacao`
--
ALTER TABLE `tb_margem_operacao`
  ADD CONSTRAINT `fk_margem_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_mot_despesa`
--
ALTER TABLE `tb_mot_despesa`
  ADD CONSTRAINT `fk_mot_despesa_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_pedagio_ida_eixo_carga`
--
ALTER TABLE `tb_pedagio_ida_eixo_carga`
  ADD CONSTRAINT `fk_pedagio_ida_eixo_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_pedagio_volta_eixo_carga`
--
ALTER TABLE `tb_pedagio_volta_eixo_carga`
  ADD CONSTRAINT `fk_pedagio_volta_eixo_carga_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_preco_litro_comb_carga`
--
ALTER TABLE `tb_preco_litro_comb_carga`
...
--
-- Restrições para tabelas `tb_subtotal_operacao`
--
ALTER TABLE `tb_subtotal_operacao`
  ADD CONSTRAINT `fk_subtotal_operacao_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_tentar_fechar_motorista`
--
ALTER TABLE `tb_tentar_fechar_motorista`
  ADD CONSTRAINT `fk_tentar_fechar_motorista_proposta` FOREIGN KEY (`cd_proposta`) REFERENCES `tb_proposta` (`cd_proposta`);

--
-- Restrições para tabelas `tb_tipo_carga`
--
ALTER TABLE `tb_tipo_carga`
