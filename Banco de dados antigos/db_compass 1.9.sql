...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/12/2023 às 20:03
...
INSERT INTO `tb_adicionais` (`cd_adicionais`, `id_isca_adicionais`, `vl_isca_adicionais`, `id_monitoramento_isca_adicionais`, `vl_monitoramento_isca_adicionais`, `id_escolta_armada_adicionais`, `vl_escolta_armada_adicionais`, `id_devolucao_margem_esquerda_adicionais`, `vl_devolucao_margem_esquerda_adicionais`, `id_devolucao_sv_adicionais`, `vl_devolucao_sv_adicionais`, `id_adic_carga_anvisa_adicionais`, `vl_adic_carga_anvisa_adicionais`, `id_adic_carga_imo_adicionais`, `vl_adic_carga_imo_adicionais`, `id_carregamento_expr_adicionais`, `vl_carregamento_expr_adicionais`, `id_util_cav_ls_adicionais`, `vl_util_cav_ls_adicionais`, `id_estadia_especial_adicionais`, `vl_estadia_especial_adicionais`, `id_sobrestadia_carreg_adicionais`, `vl_sobrestadia_carreg_adicionais`, `id_sobrestadia_retirada_adicionais`, `vl_sobrestadia_retirada_adicionais`, `cd_proposta`) VALUES
(3, 'nao', 'ISENTO', 'nao', 'ISENTO', 'nao', 'ISENTO', 'sim', '590', 'sim', '450', 'sim', '400', 'sim', '600', 'sim', '690', 'sim', '490', 'sim', '590', 'sim', '59', 'sim', '45', 3),
(4, 'nao', 'ISENTO', 'nao', 'ISENTO', 'nao', 'ISENTO', 'sim', '590', 'sim', '450', 'sim', '400', 'sim', '600', 'sim', '690', 'sim', '490', 'sim', '590', 'sim', '59', 'sim', '45', 4);
...
--
-- Despejando dados para a tabela `tb_adic_despesas`
--

INSERT INTO `tb_adic_despesas` (`cd_adic_despesas`, `vl_buonny_despesas`, `vl_gris_rastreamento_despesas`, `vl_dta_terc_despesas`, `vl_estacionamento_despesas`, `vl_ajudantes_despesas`, `cd_despesas`) VALUES
(3, 35.00, 50.00, 0.00, 110.00, 0.00, 3),
(4, 35.00, 50.00, 0.00, 110.00, 0.00, 4);
...
--
-- Despejando dados para a tabela `tb_adic_operacao`
--

INSERT INTO `tb_adic_operacao` (`cd_adic_operacao`, `vl_estacionamento`, `vl_imo`, `vl_dta`, `vl_ajudantes`, `vl_pedagio`, `cd_operacao`) VALUES
(3, 110.00, 0.00, 230.00, 0.00, 122.00, 3),
(4, 110.00, 0.00, 230.00, 0.00, 122.00, 4);
...
--
-- Despejando dados para a tabela `tb_carga`
--

INSERT INTO `tb_carga` (`cd_carga`, `nm_tipo_carga`, `vl_despesa_viagem_carga`, `cd_proposta`) VALUES
(3, 'cargaGeral', 329.31, 3),
(4, 'cargaGeral', 329.31, 4);
...
--
-- Despejando dados para a tabela `tb_cliente_proposta`
--

INSERT INTO `tb_cliente_proposta` (`cd_cliente`, `nm_empresa_cliente`, `cd_proposta`) VALUES
(3, 'Drogaria São Paulo', 3),
(4, 'Drogaria São Paulo', 4);
...
--
-- Despejando dados para a tabela `tb_combustivel_carga`
--

INSERT INTO `tb_combustivel_carga` (`cd_combustivel_carga`, `vl_quantidade_combustivel_carga`, `vl_consumo_combustivel_carga`, `vl_preco_combustivel_carga`, `vl_total_preco_combustivel_carga`, `cd_carga`) VALUES
(3, 33.33, 4.50, 6.22, 207.31, 3),
(4, 33.33, 4.50, 6.22, 207.31, 4);
...
--
-- Despejando dados para a tabela `tb_cot_aut`
--

INSERT INTO `tb_cot_aut` (`cd_cot_aut`, `nm_cot_aut`, `vl_cot_aut`, `dt_cot_aut`, `cd_proposta`) VALUES
(5, 'João', 6000.00, '2023-11-05', 3),
(6, 'Rogério', 5000.00, '2023-11-03', 3),
(7, 'João', 6000.00, '2023-11-05', 4),
(8, 'Rogério', 5000.00, '2023-11-03', 4);
...
INSERT INTO `tb_despesas` (`cd_despesas`, `vl_motorista_despesas`, `vl_pedagio_despesas`, `vl_profit_despesas`, `vl_comissao_despesas`, `pc_comissao_despesas`, `vl_despesas`, `cd_proposta`) VALUES
(3, 878.00, 122.00, 500.00, 40.00, 5.00, 54991.63, 3),
(4, 878.00, 122.00, 500.00, 40.00, 5.00, 54991.63, 4);
...
--
-- Despejando dados para a tabela `tb_email_responsavel_cliente_proposta`
--

INSERT INTO `tb_email_responsavel_cliente_proposta` (`cd_email_responsavel_cliente`, `nm_email_responsavel_cliente`, `cd_responsavel_cliente`) VALUES
(3, 'jose@drogariaSP.com.br', 3),
(4, 'jose@drogariaSP.com.br', 4);
...
INSERT INTO `tb_filial` (`cd_filial`, `nm_filial`, `cd_cnpj`, `cd_proposta`) VALUES
(3, 'ACL Cargo Santos', '06.695.952/0003', 3),
(4, 'ACL Cargo Santos', '06.695.952/0003', 4);
...
--
-- Despejando dados para a tabela `tb_frete_peso`
--

INSERT INTO `tb_frete_peso` (`cd_frete_peso`, `vl_frete_peso`, `pc_frete_peso`, `cd_proposta`) VALUES
(3, 1300.00, 30.00, 3),
(4, 1300.00, 30.00, 4);
...
--
-- Despejando dados para a tabela `tb_imp_despesas`
--

INSERT INTO `tb_imp_despesas` (`cd_imp_despesas`, `pc_rcfdc_imp_despesas`, `vl_rcfdc_imp_despesas`, `pc_rctrc_imp_despesas`, `vl_rctrc_imp_despesas`, `pc_simples_nac_imp_despesas`, `vl_simples_nac_imp_despesas`, `pc_irpj_imp_despesas`, `vl_irpj_imp_despesas`, `pc_adic_irpj_imp_despesas`, `vl_adic_irpj_imp_despesas`, `pc_pis_imp_despesas`, `vl_pis_imp_despesas`, `pc_cofins_imp_despesas`, `vl_cofins_imp_despesas`, `vl_icms_despesas`, `pc_icms_despesas`, `cd_despesas`) VALUES
(3, 6.00, 21000.00, 5.00, 17500.00, 1.50, 992.60, 1.20, 794.08, 0.20, 132.35, 0.60, 397.04, 0.80, 529.39, 11911.17, 18.00, 3),
(4, 6.00, 21000.00, 5.00, 17500.00, 1.50, 992.60, 1.20, 794.08, 0.20, 132.35, 0.60, 397.04, 0.80, 529.39, 11911.17, 18.00, 4);
...
--
-- Despejando dados para a tabela `tb_imp_operacao`
--

INSERT INTO `tb_imp_operacao` (`cd_imp_operacao`, `pc_imp_susp_imp_operacao`, `vl_imp_susp_imp_operacao`, `vl_total_imposto_seguro_operacao`, `pc_rctrc_imp_operacao`, `vl_rctrc_imp_operacao`, `pc_rcfdc_imp_operacao`, `vl_rcfdc_imp_operacao`, `ds_tipo_gris_imp_operacao`, `pc_gris_imp_operacao`, `vl_gris_imp_operacao`, `vl_valor_icms_operacao`, `pc_icms_operacao`, `cd_operacao`) VALUES
(3, 40.00, 100000.00, 350000.00, 6.00, 21000.00, 6.00, 21000.00, 'sim', 3.00, 10500.00, 11911.17, 18.00, 3),
(4, 40.00, 100000.00, 350000.00, 6.00, 21000.00, 6.00, 21000.00, 'sim', 3.00, 10500.00, 11911.17, 18.00, 4);
...
--
-- Despejando dados para a tabela `tb_km_rota_carga`
--

INSERT INTO `tb_km_rota_carga` (`cd_km_rota_carga`, `qtd_ida_km_rota_carga`, `qtd_volta_km_rota_carga`, `qtd_total_km_rota_carga`, `cd_carga`) VALUES
(3, 75.00, 75.00, 150.00, 3),
(4, 75.00, 75.00, 150.00, 4);
...
--
-- Despejando dados para a tabela `tb_mercadoria_operacao`
--

INSERT INTO `tb_mercadoria_operacao` (`cd_mercadoria_operacao`, `vl_mercadoria_operacao`, `vl_container_operacao`, `cd_operacao`) VALUES
(3, 250000.00, 0.00, 3),
(4, 250000.00, 0.00, 4);
...
INSERT INTO `tb_motorista` (`cd_motorista`, `vl_motorista`, `vl_frete_conf_antt_motorista`, `vl_pedagio_tab_motorista`, `vl_total_aut_tab_motorista`, `vl_lucro_total_aut_tab_motorista`, `vl_frete_all_in_fechado_motorista`, `vl_lucro_frete_all_in_fechado_motorista`, `vl_tentar_fechar_motorista`, `vl_lucro_tentar_fechar_motorista`, `cd_proposta`) VALUES
(3, 'R$3.2479 + R$347.47', 834.66, 122.00, 956.66, 627.35, 1000.00, 670.69, 1000.00, 670.69, 3),
(4, 'R$3.2479 + R$347.47', 834.66, 122.00, 956.66, 627.35, 1000.00, 670.69, 1000.00, 670.69, 4);
...
--
-- Despejando dados para a tabela `tb_operacao`
--

INSERT INTO `tb_operacao` (`cd_operacao`, `nm_tipo_operacao`, `nm_tipo_imposto_operacao`, `vl_frete_peso_operacao`, `vl_subtotal_operacao`, `pc_total_prest_operacao`, `vl_total_prest_operacao`, `vl_despesas_operacao`, `pc_lucro_bruto_operacao`, `vl_lucro_bruto_operacao`, `vl_margem_operacao`, `cd_proposta`) VALUES
(3, 'DTA', 'lucroPresumido', 1300.00, 54262.00, 18.91, 66173.17, 54991.63, 20.61, 11181.54, 'MARGEM OK', 3),
(4, 'DTA', 'lucroPresumido', 1300.00, 54262.00, 18.91, 66173.17, 54991.63, 20.61, 11181.54, 'MARGEM OK', 4);
...
--
-- Despejando dados para a tabela `tb_pedagio_rota_carga`
--

INSERT INTO `tb_pedagio_rota_carga` (`cd_pedagio_rota_carga`, `qtd_eixos_pedagio_rota_carga`, `vl_ida_pedagio_rota_carga`, `vl_volta_pedagio_rota_carga`, `vl_total_pedagio_rota_carga`, `cd_carga`) VALUES
(3, 2.00, 32.50, 28.50, 122.00, 3),
(4, 2.00, 32.50, 28.50, 122.00, 4);
...
INSERT INTO `tb_produto` (`cd_produto`, `nm_produto`, `qt_produto`, `qt_peso_produto`, `cd_proposta`) VALUES
(3, 'Caminhões', '4', 300.00, 3),
(4, 'Medicamento', '4', 300.00, 4);
...
INSERT INTO `tb_proposta` (`cd_proposta`, `ds_tipo_proposta`, `dt_proposta`, `nm_referencia_acl`, `nm_referencia_cliente`, `nm_versao_proposta`, `dt_horario_recebimento`, `ds_metodo_transporte`, `ds_status_proposta`, `ds_tipo_assinatura`, `cd_usuario`) VALUES
(3, 'Estudo', '2023-12-01', 'ACL MM 0003', 'Junior', 'Versão 01', '17:30:00', 'FRETE INTERNO', 'Não-Enviada', 'Não-Selecionada', 2),
(4, 'Padrão', '2023-12-01', 'ACL MM 0004', 'Junior', 'Versão 01', '17:30:00', 'FRETE INTERNO', 'Não-Enviada', 'Não-Selecionada', 1);
...
--
-- Despejando dados para a tabela `tb_responsavel_cliente_proposta`
--

INSERT INTO `tb_responsavel_cliente_proposta` (`cd_responsavel_cliente`, `nm_responsavel_cliente`, `cd_cliente`) VALUES
(3, 'José', 3),
(4, 'José', 4);
...
INSERT INTO `tb_rota` (`cd_rota`, `sg_uf_origem_rota`, `nm_cidade_origem_rota`, `sg_uf_destino_rota`, `nm_cidade_destino_rota`, `nm_local_devolucao_container_rota`, `cd_proposta`) VALUES
(3, 'SP', 'São Paulo', 'SP', 'São Vicente', NULL, 3),
(4, 'SP', 'São Paulo', 'SP', 'São Vicente', NULL, 4);
...
--
-- Despejando dados para a tabela `tb_valor_carga`
--

INSERT INTO `tb_valor_carga` (`cd_valor_carga`, `vl_preco_carga`, `nm_tipo_moeda_valor_carga`, `vl_cotacao_valor_carga`, `vl_brl_valor_carga`, `cd_carga`) VALUES
(3, 250000.00, 'dolar', 4.92, 1230000.00, 3),
(4, 250000.00, 'dolar', 4.90, 1225000.00, 4);
...
INSERT INTO `tb_veiculo` (`cd_veiculo`, `nm_veiculo`, `qt_eixos_veiculo`, `ds_carga_veiculo`, `cd_proposta`) VALUES
(3, 'Baú 3/4', 2, 'container3500kg', 3),
(4, 'Baú 3/4', 2, 'container3500kg', 4);
...
--
ALTER TABLE `tb_adic_despesas`
  MODIFY `cd_adic_despesas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_adic_operacao`
--
ALTER TABLE `tb_adic_operacao`
  MODIFY `cd_adic_operacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_carga`
  MODIFY `cd_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_cliente_proposta`
  MODIFY `cd_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_combustivel_carga`
--
ALTER TABLE `tb_combustivel_carga`
  MODIFY `cd_combustivel_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_cot_aut`
  MODIFY `cd_cot_aut` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `tb_despesas`
--
ALTER TABLE `tb_despesas`
  MODIFY `cd_despesas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_email_responsavel_cliente_proposta`
  MODIFY `cd_email_responsavel_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_filial`
  MODIFY `cd_filial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_frete_peso`
--
ALTER TABLE `tb_frete_peso`
  MODIFY `cd_frete_peso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_imp_despesas`
--
ALTER TABLE `tb_imp_despesas`
  MODIFY `cd_imp_despesas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_imp_operacao`
--
ALTER TABLE `tb_imp_operacao`
  MODIFY `cd_imp_operacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_km_rota_carga`
--
ALTER TABLE `tb_km_rota_carga`
  MODIFY `cd_km_rota_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_mercadoria_operacao`
--
ALTER TABLE `tb_mercadoria_operacao`
  MODIFY `cd_mercadoria_operacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_motorista`
--
ALTER TABLE `tb_motorista`
  MODIFY `cd_motorista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_operacao`
--
ALTER TABLE `tb_operacao`
  MODIFY `cd_operacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_pedagio_rota_carga`
--
ALTER TABLE `tb_pedagio_rota_carga`
  MODIFY `cd_pedagio_rota_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_produto`
  MODIFY `cd_produto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_proposta`
--
ALTER TABLE `tb_proposta`
  MODIFY `cd_proposta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_responsavel_cliente_proposta`
  MODIFY `cd_responsavel_cliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_rota`
--
ALTER TABLE `tb_rota`
  MODIFY `cd_rota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_valor_carga`
  MODIFY `cd_valor_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_veiculo`
  MODIFY `cd_veiculo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
