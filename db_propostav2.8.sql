...
CREATE TABLE IF NOT EXISTS tb_tipo_frete (
    ...
    CONSTRAINT fk_tipo_frete_cliente FOREIGN KEY (cd_cliente)
        REFERENCES tb_cliente (cd_cliente)
);
...
CREATE TABLE IF NOT EXISTS tb_cat_imposto_operacao (
    ...
    CONSTRAINT fk_cat_imposto_operacao__proposta FOREIGN KEY (cd__proposta)
        REFERENCES tb__proposta (cd__proposta)
);
...
CREATE TABLE IF NOT EXISTS tb_porc_imp_suspenso_operacao (
    ...
    CONSTRAINT fk_porc_imp_suspenso_operacao_proposta FOREIGN KEY (cd__proposta)
        REFERENCES tb__proposta (cd__proposta)
);
...
CREATE TABLE IF NOT EXISTS tb_imp_suspenso_operacao (
    ...
    CONSTRAINT fk_imp_suspenso_operacao_proposta FOREIGN KEY (cd__proposta)
        REFERENCES tb_proposta (cd_proposta)
);
...
CREATE TABLE IF NOT EXISTS tb_icms_operacao (
    cd_icms_operacao INT NOT NULL AUTO_INCREMENT,
    nm_icms_rota_operacao VARCHAR(5),
    vl_icms_operacao DOUBLE,
    CONSTRAINT pk_icms PRIMARY KEY (cd_icms)
);

CREATE TABLE IF NOT EXISTS tb_icms_operacao_proposta (
    cd_icms_operacao INT NOT NULL,
    cd_proposta INT NOT NULL,
    CONSTRAINT pk_icms_operacao_proposta PRIMARY KEY (cd_icms_operacao , cd_proposta),
    CONSTRAINT fk_icms_operacao_icms_proposta FOREIGN KEY (cd_icms)
        REFERENCES tb_icms_operacao (cd_icms_operacao),
    CONSTRAINT fk_icms_operacao_proposta_proposta FOREIGN KEY (cd_proposta)
        REFERENCES tb_proposta (cd_proposta)
);
...
CREATE TABLE IF NOT EXISTS tb_pis_despesas (
    ...
    CONSTRAINT fk_apis_despesas_proposta FOREIGN KEY (cd_proposta)
        REFERENCES tb_proposta (cd_proposta)
);
...
CREATE TABLE IF NOT EXISTS tb_icms_despesas (
    cd_icms_despesas INT NOT NULL AUTO_INCREMENT,
    nm_icms_rota_despesas VARCHAR(100),
    vl_icms_despesas DOUBLE,
    CONSTRAINT pk_icms_despesas PRIMARY KEY (cd_icms_despesas)
);

CREATE TABLE IF NOT EXISTS tb_icms_despesas_proposta (
    cd_icms_despesas INT NOT NULL,
    cd_proposta INT NOT NULL,
    CONSTRAINT pk_icms_despesas_proposta PRIMARY KEY (cd_icms_despesas , cd_proposta),
    CONSTRAINT fk_icms_despesas_icms_proposta FOREIGN KEY (cd_icms_despesas)
        REFERENCES tb_icms_despesas (cd_icms_despesas),
    CONSTRAINT fk_icms_despesas_proposta_proposta FOREIGN KEY (cd_proposta)
        REFERENCES tb_proposta (cd_proposta)
);
